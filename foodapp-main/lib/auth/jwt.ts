...
import { AUTH_SECRET, SESSION_TTL_SECONDS } from "./config.ts";
...
export function signAuthToken(claims: Record<string, unknown>, ttlSeconds: number = SESSION_TTL_SECONDS): string {
